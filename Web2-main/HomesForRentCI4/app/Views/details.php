                ...
                <form action="#" method="POST">
                    ...
                    <div class="row">
                        <div class="mb-3 col-12 col-md-12">
                            <label for="myCarouselPics" class="form-label">Pictures</label>
                            <div id="myCarouselPics" class="carousel slide" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="<?php echo"{$apartmentDetails[0]->pic1}" ?>" class="d-block w-100" alt="Not found...=(" style="height:500px">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="<?php echo"{$apartmentDetails[0]->pic2}" ?>" class="d-block w-100" alt="Not found...=(" style="height:500px" >
                                    </div>
                                    <div class="carousel-item">
                                        <img src="<?php echo"{$apartmentDetails[0]->pic3}" ?>" class="d-block w-100" alt="Not found...=(" style="height:500px">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="<?php echo"{$apartmentDetails[0]->pic4}" ?>" class="d-block w-100" alt="Not found...=(" style="height:500px">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="<?php echo"{$apartmentDetails[0]->pic5}" ?>" class="d-block w-100" alt="Not found...=(" style="height:500px">
                                    </div>
                                </div>
                    ...
                    <div class="d-grid">
                        <a href="<?php echo base_url().'/ownerListApt'?>" class="btn btn-primary">BACK</a>
                    </div>                            
                </form>   
